...
lst1=os.listdir('siameseData/output_pth')
data=pd.read_csv('siameseData/data.csv')
X=list()
Y=list()
...
for i in range(len(lst1)):
    fname_img=lst1[i]
    file_to_read='siameseData/output_pth/'+str(fname_img)
    print(file_to_read)
    # print(file_to_read)
...
print(x_n.shape)
print(y_n.shape)
np.save('siamese_x2',x_n)
np.save('siamese_y2',y_n)
